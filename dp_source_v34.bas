    ...
    dim notused38a = var68
    dim notused66a = var69
    dim notused77a = var70
    ...
    dim notused11a = var82
    dim notused12a = var83  
    dim message_select = var84 
...
skiphealthcheck
   ...
   ;──═◙ Debounce Fire Buttons
    ...
    ;crosshair_x_offset_1  laser_y_offset_10
...
skip1
    ...
    ;if laserLo>$15 && healthLo>$25 then message_select=1  ; default message
    ;if laserLo<$16 && healthLo>$25 then message_select=2  ; laser level low, health normal
    ;if laserLo>$15 && healthLo<$26 then message_select=3  ; laser level normal, health low
    ;if laserLo<$16 && healthLo<$26 then message_select=4  ; laser and health are low
